...
void reduzB(char *array1, char *array2)
{
    ...
    for (i = F; i <= nF; i++) // copiando o elemento G para o array2
    {
        array2[k] = array1[i];
        k++;
    }
...
void reduzC(char *array1, char *array2)
{
    ...
    for (i = F; i <= nF; i++) // copiando o elemento F para o array2
    {
        array2[k] = array1[i];
        k++;
    }
...
// Procedimento que recebe duas variáveis que apontam para
// dois arrays e executa a regra do combinador S1: c f g x => c (f x) (g x)
// copiando os argumentos do array1 para o array2.
void reduzD(char *array1, char *array2)
{
    ...
    for (i = C; i <= nC; i++) // copiando o elemento C para o array2
    {
        array2[k] = array1[i];
        k++;
    }
...
// Procedimento que recebe duas variáveis que apontam para
// dois arrays e executa a regra do combinador B1: c f g x => c f (g x)
// copiando os argumentos do array1 para o array2.
...
// Procedimento que recebe duas variáveis que apontam para
// dois arrays e executa a regra do combinador C1: c f g x => c (f x) g
// copiando os argumentos do array1 para o array2.
